            ...
            <Grid container spacing={2}>
              <Grid item>
                <ButtonBase className={classes.image}>
                  <img className={classes.img} alt="Chocolate Thai" src="https://i.imgur.com/OJTlSOo.png" />
                </ButtonBase>
              </Grid>
...
export default withRouter(ChocolateThai);