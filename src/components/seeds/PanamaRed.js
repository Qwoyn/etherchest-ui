            ...
            <Grid container spacing={2}>
              <Grid item>
                <ButtonBase className={classes.image}>
                  <img className={classes.img} alt="Panama Red" src="https://i.imgur.com/BZdquR9.png" />
                </ButtonBase>
              </Grid>
...
export default withRouter(PanamaRed);