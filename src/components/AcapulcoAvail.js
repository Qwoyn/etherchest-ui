...
const rows = [
  createData('Test User', 3.05),
  createData('Test User', 4.52),
  createData('Test User', 2.62),
  createData('Test User', 1.59),
  createData('Test User', 3.56),
  createData('Test User', 4.08),
  createData('Test User', 2.37),
  createData('Test User', 3.75),
  createData('Test User', 5.18),
  createData('Test User', 3.92),
  createData('Test User', 3.18),
  createData('Test User', 3.60),
  createData('Test User', 4.37),
];
...
export default function AcapulcoAvail() {
